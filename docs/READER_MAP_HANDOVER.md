...
| Route itinerary and radar/status card | `js/render.js:799-828` |
...
- Origin/destination assignment, swapping, clearing, route drawing, and itinerary generation.
...
### Contribution and Itinerary Dock Collisions

The hidden contribution card, centered legend, itinerary bottom dock, and footer share the lower viewport. If the contribution banner is restored, explicitly test:
