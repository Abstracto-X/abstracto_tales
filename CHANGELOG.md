...
- 17:08 +05:30: Linked the main page's "Read" button to the subscription Single Page Application (subscription.html) and added a router intercept in `js/router.js` to redirect legacy `#read/:slug` hash routes to `subscription.html#/story/:slug` for a unified reading experience.
